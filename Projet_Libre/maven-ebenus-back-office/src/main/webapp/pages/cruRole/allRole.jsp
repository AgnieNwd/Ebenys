		...
		<a class="nav-link" href="${pageContext.request.contextPath}/LogoutServlet" style="color: #e3f2fd"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
  		...
  		<div class="row" style="margin:0;">
    		...
    		<div class="col-md-9">
    			...
    			<hr>
    			<p>
    				Ajouter un nouveau role  > <a href="${pageContext.request.contextPath}/CreateRoleServlet" ><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
    			</p>
				...
				%>
					  <li class="list-group-item">
						    <p>
							  	<%= allRoles.get(i).getIdentifiant() %>  
						  		<a href="${pageContext.request.contextPath}/UpdateRoleServlet?id=<%=allRoles.get(i).getIdRole() %>"><i class="fa fa-pencil"></i></a>
						    </p>
				  			<p class="text-muted">
							  	<%= allRoles.get(i).getDescription() %>
							</p>
					  </li>
				<% } %>
				</ul>
