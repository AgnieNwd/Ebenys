...
<body>
	...
	<% 
		...
		List<Classe> allClasses = (List<Classe>) request.getAttribute("allClasses");
		String mode = (String) request.getAttribute("mode");
		
		Classe classeUpdate = null;

		if (mode == "update") {
			classeUpdate = (Classe) request.getAttribute("classeUpdate");
		}
 	%>
<div class="contenu">
  		...
  		<div class="row" style="margin:0;">
  			<div class="col-md-2">
				<nav id="menu-nav" class="nav nav-tabs flex-column" style="margin-top:6px;">
				  ...
				  <a class="nav-link active" href="${pageContext.request.contextPath}/CrudClasseServlet">Gestion des Classes</a>
    		...
    		<div class="col-md-9">
				...
				<div class="card border-primary mb-3" style="width: 25rem;">
				  <div class="card-body">
				    <h5 class="card-title">Modifier la classe <%= classeUpdate.getLibelleClasse() %></h5>
				    <form  method="post" action="${pageContext.request.contextPath}/UpdateClasseServlet" id="customer-info-form" class="no-gutters">  
				    	<div style="margin-bottom: 10px">
				    		<label for="validationCustom01">Nom de la Classe :</label>
			    			<input type="text" class="form-control" id="validationCustom01" value="<c:out value='${classeUpdate.getLibelleClasse()}'/>" name="name" placeholder="<c:out value='${classeUpdate.getLibelleClasse()}'/>" required>
		  				</div>
				...
				<div class="card border-primary mb-3" style="width: 25rem;">
				  <div class="card-body">
				    ...
				    <form  method="post" action="${pageContext.request.contextPath}/CreateClasseServlet" id="customer-info-form" class="no-gutters">
				 		<div style="margin-bottom: 10px">
					    	<label for="validationCustom01">Nom de la Classe :</label>
