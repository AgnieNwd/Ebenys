		...
		<a class="nav-link" href="${pageContext.request.contextPath}/LogoutServlet" style="color: #e3f2fd"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
  		...
  		<div class="row" style="margin:0;">
    		...
    		<div class="col-md-9">
    			...
    			<hr>
    			<p>
    				Ajouter une nouvelle classe  > <a href="${pageContext.request.contextPath}/CreateClasseServlet" ><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
    			</p>
				...
				%>
					  <li class="list-group-item">
						    <p>
							  	<%= allClasses.get(i).getLibelleClasse() %>  
						  		<a href="${pageContext.request.contextPath}/UpdateClasseServlet?id=<%=allClasses.get(i).getIdClasse() %>"><i class="fa fa-pencil"></i></a>
						  		<% if (allClasses.get(i).getIdClasse() != 1) { %>
							  		<a onclick="return confirm('Vous etes sûr ?')" href="${pageContext.request.contextPath}/CrudClasseServlet?action=delete&id=<%=allClasses.get(i).getIdClasse() %>" class="no-style-btn"><i class="fa fa-trash-o"></i></a>
						    	<% } %>
						    </p>
					  </li>
				<% } %>
