...
//    }
    ...
    @Test
    public void tesFindUtilisateursByIdentifiantRole() {
    	System.out.println("Entrée de la methode tesFindUtilisateursByIdentifiantRole()");
    	...
    	if (usersListByIdentifiantRole != null) {
    		...
    		Assert.fail("users with the identifiant role "+USERS_FIND_BY_IDENTIFIANT_ROLE_UTILISATEUR+" not found");
    	}
    	System.out.println("Sortie de la methode tesFindUtilisateursByIdentifiantRole()");
    }
    /*
    ...
    public void testCreateUtilisateur() {
    	...
    	Utilisateur newUser = new Utilisateur(6, "mllx", "cat", "arina", "111111", "mdp", new Date(), new Role(1, "admin", "administrateur"));
    	newUser = serviceFacade.getUtilisateurDao().createUtilisateur(newUser);
    	Utilisateur newUserFound = serviceFacade.getUtilisateurDao().findUtilisateurById(6);
    	if (newUserFound != null) { 		
    		System.out.println("New User found with ID #6 is not null");
    ...
    public void testCreateRole() {
    	...
    	Role newRole = new Role(3, "super", "superviseur");
    ...
    public void testUpdateUtilisateur() {
    	System.out.println("Entrée de la methode testUpdateUtilisateur()");
    	Utilisateur newUser = new Utilisateur(5, "mme", "eli", "brown", "124124", "mdp", new Date(), new Role(1, "admin", "administrateur"));
    	newUser = serviceFacade.getUtilisateurDao().updateUtilisateur(newUser);
    	Utilisateur userChanged = serviceFacade.getUtilisateurDao().findUtilisateurById(5);
    	if (userChanged != null) { 		
    ...
    public void testUpdateRole() {
    	...
    	Role newRole = new Role(2, "achat", "acheteur");
    	newRole = serviceFacade.getRoleDao().updateRole(newRole);
    	Role roleChanged = serviceFacade.getRoleDao().findRoleById(2);
    	if (roleChanged != null) { 		
    ...
    public void testDeleteUtilisateur() {
    	...
    	Utilisateur userToRemove = serviceFacade.getUtilisateurDao().findUtilisateurById(4);
    	boolean isUserRemoved = serviceFacade.getUtilisateurDao().deleteUtilisateur(userToRemove);
    	Utilisateur userFound = serviceFacade.getUtilisateurDao().findUtilisateurById(4);
    ...
    public void testDeleteRemove() {
    	...
    	Role roleToRemove = serviceFacade.getRoleDao().findRoleById(2);
    	boolean isRoleRemoved = serviceFacade.getRoleDao().deleteRole(roleToRemove);
    	Role roleFound = serviceFacade.getRoleDao().findRoleById(2);
